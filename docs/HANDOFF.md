...
* **In PR**: T-007 `gtanetwork create` + freeroam entirely in TypeScript (`task/T-007-freeroam-typescript`): `Tools/GTANetwork.Cli`,
  `templates/resource/`, `runtime/gtan/enums.generated.ts` + `gtan.parseEnum`, `eng/integration-test-template.sh`.
...
0. **Tasks, in order** (`docs/PLAN.md` §4, D-12): merge T-007 when green → **T-009** session encryption → **T-010** launcher GUI → **T-011**
