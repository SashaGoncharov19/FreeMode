// Generated by Tools/GTANetwork.TypeGen from GTANetworkServer.dll. Do not edit; run the generator (types/README.md).
...
interface API {
    ...
    readonly onResourceStart: HostEvent<APIEmptyEvent>;
    readonly onResourceStop: HostEvent<APIEmptyEvent>;
    readonly onUpdate: HostEvent<APIEmptyEvent>;
    readonly onChatMessage: HostEvent<APIChatEvent>;
    ...
    readonly onPlayerRespawn: HostEvent<APIPlayerEvent>;
    readonly onClientEventTrigger: HostEvent<APIServerEventTrigger>;
    readonly onPlayerPickup: HostEvent<APIPickupEvent>;
    readonly onPickupRespawn: HostEvent<APIEntityEvent>;
    readonly onMapChange: HostEvent<APIMapChangeEvent>;
    readonly onPlayerEnterVehicle: HostEvent<APIVehicleChangeEvent>;
    readonly onPlayerExitVehicle: HostEvent<APIVehicleChangeEvent>;
    readonly onVehicleDeath: HostEvent<APIEntityEvent>;
    readonly onEntityEnterColShape: HostEvent<APIGlobalColShapeEvent>;
    readonly onEntityExitColShape: HostEvent<APIGlobalColShapeEvent>;
    readonly onEntityDataChange: HostEvent<APIEntityDataChangedEvent>;
    readonly onServerResourceStart: HostEvent<APIResourceEvent>;
    readonly onServerResourceStop: HostEvent<APIResourceEvent>;
    readonly onVehicleHealthChange: HostEvent<APIEntityHealthEvent>;
    readonly onPlayerHealthChange: HostEvent<APIPlayerIntEvent>;
    readonly onPlayerArmorChange: HostEvent<APIPlayerIntEvent>;
    readonly onPlayerWeaponSwitch: HostEvent<APIPlayerWeaponEvent>;
    readonly onPlayerWeaponAmmoChange: HostEvent<APIPlayerAmmoEvent>;
    readonly onVehicleSirenToggle: HostEvent<APIEntityBooleanEvent>;
    readonly onVehicleDoorBreak: HostEvent<APIEntityIntEvent>;
    readonly onVehicleWindowSmash: HostEvent<APIEntityIntEvent>;
    readonly onVehicleTyreBurst: HostEvent<APIEntityIntEvent>;
    readonly onVehicleTrailerChange: HostEvent<APITrailerEvent>;
    readonly onPlayerModelChange: HostEvent<APIPlayerIntEvent>;
    readonly onPlayerDetonateStickies: HostEvent<APIPlayerEvent>;
    getResourceFolder(): string;
    getResourceName(resource: string): string;
    getResourceDescription(resource: string): string;
    getResourceAuthor(resource: string): string;
    getResourceVersion(resource: string): string;
    getResourceType(resource: string): ResourceType;
    getResourceCommands(resource: string): string[];
    getResourceCommandInfos(resource: string): CommandInfo[];
    getResourceCommandInfo(resource: string, command: string): CommandInfo;
    getMapGamemodes(resource: string): string[];
    getCurrentGamemode(): string;
    setServerName(serverName: string): void;
    getMapsForGamemode(gamemode: string): string[];
    hasSetting(settingName: string): boolean;
    getSetting<T>(settingName: string): T;
    setSetting(settingName: string, value: unknown): void;
    hasResourceSetting(resource: string, settingName: string): boolean;
    getResourceSetting<T>(resource: string, setting: string): T;
    setResourceSetting(resource: string, setting: string, value: unknown): void;
    getResourceSettings(resource: string): string[];
    getResourceSettingDescription(resource: string, setting: string): string;
    doesConfigExist(configName: string): boolean;
    loadConfig(configName: string): GTANetworkServerXmlGroup;
    loadXml(path: string): GTANetworkServerXmlGroup;
    fromJson(json: string): unknown;
    toJson(data: unknown): string;
    call(className: string, methodName: string, ...arguments_: unknown[]): unknown;
    startResource(resourceName: string): boolean;
    stopResource(name: string): boolean;
    isResourceRunning(resource: string): boolean;
    doesResourceExist(resource: string): boolean;
    getRunningResources(): string[];
    getAllResources(): string[];
    playSoundFrontEnd(target: Client, SoundName: string, SoundSetName: string): void;
    setGamemodeName(newName: string): void;
    getEntityType(handle: NetHandle): EntityType;
    getPlayerFromHandle(handle: NetHandle): Client;
    getEntityFromHandle<T>(handle: NetHandle): T;
    isPlayerConnected(player: Client): boolean;
    isPlayerOnFire(player: Client): boolean;
    isPlayerParachuting(player: Client): boolean;
    isPlayerInFreefall(player: Client): boolean;
    isPlayerAiming(player: Client): boolean;
    isPlayerShooting(player: Client): boolean;
    isPlayerReloading(player: Client): boolean;
    isPlayerInCover(player: Client): boolean;
    isPlayerOnLadder(player: Client): boolean;
    getPlayerAimingPoint(player: Client): Vector3;
    isPlayerInAnyVehicle(player: Client): boolean;
    isPlayerDead(player: Client): boolean;
    isPlayerRespawning(player: Client): boolean;
    ...
    startThread(target: () => void): unknown /* System.Threading.Thread */;
    delay(ms: number, once: boolean, target: () => void): void;
    /** Notice: not available in the Script constructor. Use onResourceStart even instead.  */
    getThisResource(): string;
    getHashKey(input: string): number;
    getHashSHA256(input: string): string;
    loginPlayer(player: Client, password: string): number;
    logoutPlayer(player: Client): void;
    doesPlayerHaveAccessToCommand(player: Client, cmd: string): boolean;
    isPlayerLoggedIn(player: Client): boolean;
    isAclEnabled(): boolean;
    getPlayerAclGroup(player: Client): string;
    consoleOutput(text: string): void;
    consoleOutput(text: string, ...args: unknown[]): void;
    consoleOutput(category: LogCat, text: string): void;
    consoleOutput(category: LogCat, text: string, ...args: unknown[]): void;
    downloadData(target: Client, data: string): void;
    doesEntityExistForPlayer(player: Client, entity: NetHandle): boolean;
    setEntityTransparency(entity: NetHandle, newAlpha: number): void;
    getEntityTransparency(entity: NetHandle): number;
    setEntityDimension(entity: NetHandle, dimension: number): void;
    getEntityDimension(entity: NetHandle): number;
    setEntityInvincible(entity: NetHandle, invincible: boolean): void;
    getEntityInvincible(entity: NetHandle): boolean;
    createParticleEffectOnPosition(ptfxLibrary: string, ptfxName: string, position: Vector3, rotation: Vector3, scale: number, dimension?: number): void;
    createParticleEffectOnEntity(ptfxLibrary: string, ptfxName: string, entity: NetHandle, offset: Vector3, rotation: Vector3, scale: number, boneIndex?: number, dimension?: number): void;
    createExplosion(explosionType: ExplosionType, position: Vector3, damageScale?: number, dimension?: number): void;
    createOwnedExplosion(owner: Client, explosionType: ExplosionType, position: Vector3, damageScale?: number, dimension?: number): void;
    createProjectile(weapon: WeaponHash, start: Vector3, target: Vector3, damage: number, speed?: number, dimension?: number): void;
    createOwnedProjectile(owner: Client, weapon: WeaponHash, start: Vector3, target: Vector3, damage: number, speed?: number, dimension?: number): void;
    setPlayerNametag(player: Client, text: string): void;
    getPlayerNametag(player: Client): string;
    resetPlayerNametag(player: Client): void;
    setPlayerNametagVisible(player: Client, visible: boolean): void;
    getPlayerNametagVisible(player: Client): boolean;
    setPlayerNametagColor(player: Client, r: number, g: number, b: number): void;
    getPlayerNametagColor(player: Client): ConstantColor;
    resetPlayerNametagColor(player: Client): void;
    setPlayerToSpectator(player: Client): void;
    setPlayerToSpectatePlayer(player: Client, target: Client): void;
    unspectatePlayer(player: Client): void;
    isPlayerSpectating(player: Client): boolean;
    explodeVehicle(vehicle: NetHandle): void;
    setVehicleLivery(vehicle: NetHandle, livery: number): void;
    getVehicleOccupants(vehicle: NetHandle): Client[];
    getVehicleDriver(vehicle: NetHandle): Client;
    getVehicleLivery(vehicle: NetHandle): number;
    setVehicleLocked(vehicle: NetHandle, locked: boolean): void;
    getVehicleLocked(vehicle: NetHandle): boolean;
    getVehicleTrailer(vehicle: NetHandle): NetHandle;
    getVehicleTraileredBy(vehicle: NetHandle): NetHandle;
    getVehicleSirenState(vehicle: NetHandle): boolean;
    isVehicleTyrePopped(vehicle: NetHandle, tyre: number): boolean;
    popVehicleTyre(vehicle: NetHandle, tyre: number, pop: boolean): void;
    isVehicleDoorBroken(vehicle: NetHandle, door: number): boolean;
    breakVehicleDoor(vehicle: NetHandle, door: number, breakDoor: boolean): void;
    setVehicleDoorState(vehicle: NetHandle, door: number, open: boolean): void;
    getVehicleDoorState(vehicle: NetHandle, door: number): boolean;
    isVehicleWindowBroken(vehicle: NetHandle, window: number): boolean;
    breakVehicleWindow(vehicle: NetHandle, window: number, breakWindow: boolean): void;
    setVehicleExtra(vehicle: NetHandle, slot: number, enabled: boolean): void;
    getVehicleExtra(vehicle: NetHandle, slot: number): boolean;
    setVehicleNumberPlate(vehicle: NetHandle, plate: string): void;
    getVehicleNumberPlate(vehicle: NetHandle): string;
    setVehicleEngineStatus(vehicle: NetHandle, turnedOn: boolean): void;
    getVehicleEngineStatus(vehicle: NetHandle): boolean;
    setVehicleSpecialLightStatus(vehicle: NetHandle, turnedOn: boolean): void;
    getVehicleSpecialLightStatus(vehicle: NetHandle): boolean;
    setEntityCollisionless(entity: NetHandle, collisionless: boolean): void;
    getEntityCollisionless(entity: NetHandle): boolean;
    getEntityModel(ent: NetHandle): number;
    setEntitySyncedData(entity: NetHandle, key: string, value: unknown): boolean;
    getEntitySyncedData(entity: NetHandle, key: string): unknown;
    getAllEntitySyncedData(entity: NetHandle): string[];
    resetEntitySyncedData(entity: NetHandle, key: string): void;
    hasEntitySyncedData(entity: NetHandle, key: string): boolean;
    setWorldSyncedData(key: string, value: unknown): boolean;
    ...
    setEntityData(entity: NetHandle, key: string, value: unknown): boolean;
    getEntityData(entity: NetHandle, key: string): unknown;
    resetEntityData(entity: NetHandle, key: string): void;
    hasEntityData(entity: NetHandle, key: string): boolean;
    getAllEntityData(entity: NetHandle): string[];
    setWorldData(key: string, value: unknown): boolean;
    getWorldData(key: string): unknown;
    getAllWorldData(): string[];
    resetWorldData(key: string): void;
    hasWorldData(key: string): boolean;
    setVehicleMod(vehicle: NetHandle, modType: number, mod: number): void;
    getVehicleMod(vehicle: NetHandle, slot: number): number;
    removeVehicleMod(vehicle: NetHandle, modType: number): void;
    setVehicleBulletproofTyres(vehicle: NetHandle, bulletproof: boolean): void;
    getVehicleBulletproofTyres(vehicle: NetHandle): boolean;
    setVehicleNumberPlateStyle(vehicle: NetHandle, style: number): void;
    getVehicleNumberPlateStyle(vehicle: NetHandle): number;
    setVehiclePearlescentColor(vehicle: NetHandle, color: number): void;
    getVehiclePearlescentColor(vehicle: NetHandle): number;
    setVehicleWheelColor(vehicle: NetHandle, color: number): void;
    getVehicleWheelColor(vehicle: NetHandle): number;
    setVehicleWheelType(vehicle: NetHandle, type_: number): void;
    getVehicleWheelType(vehicle: NetHandle): number;
    setVehicleModColor1(vehicle: NetHandle, r: number, g: number, b: number): void;
    getVehicleModColor1(vehicle: NetHandle): ConstantColor;
    setVehicleModColor2(vehicle: NetHandle, r: number, g: number, b: number): void;
    getVehicleModColor2(vehicle: NetHandle): ConstantColor;
    setVehicleTyreSmokeColor(vehicle: NetHandle, r: number, g: number, b: number): void;
    getVehicleTyreSmokeColor(vehicle: NetHandle): ConstantColor;
    setVehicleWindowTint(vehicle: NetHandle, type_: number): void;
    getVehicleWindowTint(vehicle: NetHandle): number;
    setVehicleEnginePowerMultiplier(vehicle: NetHandle, mult: number): void;
    getVehicleEnginePowerMultiplier(vehicle: NetHandle): number;
    setVehicleEngineTorqueMultiplier(vehicle: NetHandle, mult: number): void;
    getVehicleEngineTorqueMultiplier(vehicle: NetHandle): number;
    setVehicleNeonState(vehicle: NetHandle, slot: number, turnedOn: boolean): void;
    getVehicleNeonState(vehicle: NetHandle, slot: number): boolean;
    setVehicleNeonColor(vehicle: NetHandle, r: number, g: number, b: number): void;
    getVehicleNeonColor(vehicle: NetHandle): ConstantColor;
    setVehicleDashboardColor(vehicle: NetHandle, type_: number): void;
    getVehicleDashboardColor(vehicle: NetHandle): number;
    setVehicleTrimColor(vehicle: NetHandle, type_: number): void;
    getVehicleTrimColor(vehicle: NetHandle): number;
    getVehicleDisplayName(model: VehicleHash): string;
    getVehicleMaxSpeed(model: VehicleHash): number;
    getVehicleMaxBraking(model: VehicleHash): number;
    getVehicleMaxTraction(model: VehicleHash): number;
    getVehicleMaxAcceleration(model: VehicleHash): number;
    getVehicleMaxOccupants(model: VehicleHash): number;
    getVehicleClass(model: VehicleHash): number;
    getVehicleClassName(classId: number): string;
    detonatePlayerStickies(player: Client): void;
    setPlayerSkin(player: Client, modelHash: PedHash): void;
    setPlayerDefaultClothes(player: Client): void;
    ...
    setPlayerTeam(player: Client, team: number): void;
    getPlayerTeam(player: Client): number;
    playPlayerAnimation(player: Client, flag: number, animDict: string, animName: string): void;
    playPlayerScenario(player: Client, scenarioName: string): void;
    stopPlayerAnimation(player: Client): void;
    playPedAnimation(ped: NetHandle, looped: boolean, animDict: string, animName: string): void;
    playPedScenario(ped: NetHandle, scenario: string): void;
    stopPedAnimation(ped: NetHandle): void;
    setTime(hours: number, minutes: number): void;
    getTime(): TimeSpan;
    freezePlayerTime(client: Client, freeze: boolean): void;
    setVehiclePrimaryColor(vehicle: NetHandle, color: number): void;
    setVehicleCustomPrimaryColor(vehicle: NetHandle, red: number, green: number, blue: number): void;
    setVehicleSecondaryColor(vehicle: NetHandle, color: number): void;
    setVehicleCustomSecondaryColor(vehicle: NetHandle, red: number, green: number, blue: number): void;
    getVehiclePrimaryColor(vehicle: NetHandle): number;
    getVehicleCustomPrimaryColor(vehicle: NetHandle): ConstantColor;
    getVehicleSecondaryColor(vehicle: NetHandle): number;
    getVehicleCustomSecondaryColor(vehicle: NetHandle): ConstantColor;
    getPlayerFromName(name: string): Client;
    getPlayerPing(player: Client): number;
    getPlayersInRadiusOfPlayer(radius: number, player: Client): Client[];
    getPlayersInRadiusOfPosition(radius: number, position: Vector3): Client[];
    setPlayerClothes(player: Client, slot: number, drawable: number, texture: number): void;
    getPlayerClothesDrawable(player: Client, slot: number): number;
    getPlayerClothesTexture(player: Client, slot: number): number;
    setPlayerAccessory(player: Client, slot: number, drawable: number, texture: number): void;
    clearPlayerAccessory(player: Client, slot: number): void;
    getPlayerAccessoryDrawable(player: Client, slot: number): number;
    getPlayerAccessoryTexture(player: Client, slot: number): number;
    clearPlayerTasks(player: Client): void;
    vehicleNameToModel(modelName: string): VehicleHash;
    pedNameToModel(modelName: string): PedHash;
    pickupNameToModel(modelName: string): PickupHash;
    weaponNameToModel(modelName: string): WeaponHash;
    getAllPlayers(): Client[];
    getAllVehicles(): NetHandle[];
    getAllObjects(): NetHandle[];
    getAllMarkers(): NetHandle[];
    getAllBlips(): NetHandle[];
    getAllPickups(): NetHandle[];
    getAllLabels(): NetHandle[];
    getAllPeds(): NetHandle[];
    setEntityPositionFrozen(player: Client, entity: NetHandle, frozen: boolean): void;
    ...
    sendChatMessageToPlayer(player: Client, sender: string, message: string): void;
    setPlayerWantedLevel(player: Client, wantedLevel: number): void;
    getPlayerWantedLevel(player: Client): number;
    setPlayerName(player: Client, newName: string): boolean;
    getPlayerName(player: Client): string;
    getPlayerVelocity(player: Client): Vector3;
    setPlayerVelocity(player: Client, velocity: Vector3): void;
    getPlayerVehicleSeat(player: Client): number;
    sendNativeToPlayer(player: Client, longHash: number, ...args: unknown[]): void;
    sendNativeToPlayer(player: Client, native: Hash, ...args: unknown[]): void;
    sendNativeToAllPlayers(longHash: number, ...args: unknown[]): void;
    sendNativeToAllPlayers(native: Hash, ...args: unknown[]): void;
    sendNativeToPlayersInRange(pos: Vector3, range: number, hash: number, ...args: unknown[]): void;
    sendNativeToPlayersInRange(pos: Vector3, range: number, native: Hash, ...args: unknown[]): void;
    sendNativeToPlayersInRangeInDimension(pos: Vector3, range: number, dimension: number, hash: number, ...args: unknown[]): void;
    sendNativeToPlayersInRangeInDimension(pos: Vector3, range: number, dimension: number, native: Hash, ...args: unknown[]): void;
    sendNativeToPlayersInDimension(dimension: number, hash: number, ...args: unknown[]): void;
    sendNativeToPlayersInDimension(dimension: number, native: Hash, ...args: unknown[]): void;
    givePlayerWeapon(player: Client, weaponHash: WeaponHash, ammo: number, equipNow: boolean, ammoLoaded: boolean): void;
    getPlayerWeaponAmmo(player: Client, weaponHash: WeaponHash): number;
    setPlayerWeaponAmmo(player: Client, weaponHash: WeaponHash, ammo: number): void;
    removePlayerWeapon(player: Client, weapon: WeaponHash): void;
    removeAllPlayerWeapons(player: Client): void;
    setPlayerWeaponTint(player: Client, weapon: WeaponHash, tint: WeaponTint): void;
    getPlayerWeaponTint(player: Client, weapon: WeaponHash): WeaponTint;
    getPlayerWeaponComponents(player: Client, weapon: WeaponHash): WeaponComponent[];
    givePlayerWeaponComponent(player: Client, weapon: WeaponHash, component: WeaponComponent): void;
    removePlayerWeaponComponent(player: Client, weapon: WeaponHash, component: WeaponComponent): void;
    getAllWeaponComponents(weapon: WeaponHash): WeaponComponent[];
    hasPlayerGotWeaponComponent(player: Client, weapon: WeaponHash, component: WeaponComponent): boolean;
    getPlayerWeapons(player: Client): WeaponHash[];
    ...
    isEntityAttachedToAnything(entity: NetHandle): boolean;
    isEntityAttachedToEntity(entity: NetHandle, attachedTo: NetHandle): boolean;
    detachEntity(entity: NetHandle, resetCollision?: boolean): void;
    setPlayerSeatbelt(player: Client, seatbelt: boolean): void;
    getPlayerSeatbelt(player: Client): boolean;
    freezePlayer(player: Client, freeze: boolean): void;
    setEntityRotation(netHandle: NetHandle, newRotation: Vector3): void;
    getEntityPosition(entity: NetHandle): Vector3;
    getEntityRotation(entity: NetHandle): Vector3;
    getEntityVelocity(entity: NetHandle): Vector3;
    setPlayerIntoVehicle(player: Client, vehicle: NetHandle, seat: number): void;
    warpPlayerOutOfVehicle(player: Client): void;
    doesEntityExist(entity: NetHandle): boolean;
    setVehicleHealth(vehicle: NetHandle, health: number): void;
    getVehicleHealth(vehicle: NetHandle): number;
    getPickupAmount(pickup: NetHandle): number;
    getPickupCustomModel(pickup: NetHandle): number;
    getPickupPickedUp(pickup: NetHandle): boolean;
    repairVehicle(vehicle: NetHandle): void;
    setPlayerHealth(player: Client, health: number): void;
    getPlayerHealth(player: Client): number;
    setPlayerArmor(player: Client, armor: number): void;
    getPlayerArmor(player: Client): number;
    setBlipColor(blip: NetHandle, color: number): void;
    getBlipColor(blip: NetHandle): number;
    setBlipName(blip: NetHandle, name: string): void;
    getBlipName(blip: NetHandle): string;
    setBlipTransparency(blip: NetHandle, alpha: number): void;
    getBlipTransparency(blip: NetHandle): number;
    setBlipShortRange(blip: NetHandle, range: boolean): void;
    getBlipShortRange(blip: NetHandle): boolean;
    setBlipPosition(blip: NetHandle, newPos: Vector3): void;
    getBlipPosition(blip: NetHandle): Vector3;
    setBlipSprite(blip: NetHandle, sprite: number): void;
    getBlipSprite(blip: NetHandle): number;
    setBlipScale(blip: NetHandle, scale: number): void;
    getBlipScale(blip: NetHandle): number;
    setBlipRouteVisible(blip: NetHandle, visible: boolean): void;
    getBlipRouteVisible(blip: NetHandle): boolean;
    setBlipRouteColor(blip: NetHandle, color: number): void;
    getBlipRouteColor(blip: NetHandle): number;
    sendNotificationToPlayer(player: Client, message: string, flashing?: boolean): void;
    sendNotificationToAll(message: string, flashing?: boolean): void;
    sendPictureNotificationToPlayer(player: Client, body: string, pic: string, flash: number, iconType: number, sender: string, subject: string): void;
    sendPictureNotificationToAll(body: string, pic: string, flash: number, iconType: number, sender: string, subject: string): void;
    setMarkerType(marker: NetHandle, type_: number): void;
    getMarkerType(marker: NetHandle): number;
    setMarkerScale(marker: NetHandle, scale: Vector3): void;
    getMarkerBobUpAndDown(marker: NetHandle): boolean;
    setMarkerBobUpAndDown(marker: NetHandle, state: boolean): void;
    getMarkerScale(marker: NetHandle): Vector3;
    setMarkerDirection(marker: NetHandle, dir: Vector3): void;
    getMarkerDirection(marker: NetHandle): Vector3;
    setMarkerColor(marker: NetHandle, alpha: number, red: number, green: number, blue: number): void;
    getMarkerColor(marker: NetHandle): ConstantColor;
    getPlayerVehicle(player: Client): NetHandle;
    setTextLabelText(label: NetHandle, newText: string): void;
    getTextLabelText(label: NetHandle): string;
    setTextLabelRange(label: NetHandle, newRange: number): void;
    getTextLabelRange(label: NetHandle): number;
    setTextLabelColor(label: NetHandle, red: number, green: number, blue: number, alpha: number): void;
    getTextLabelColor(label: NetHandle): ConstantColor;
    setTextLabelSeethrough(label: NetHandle, seethrough: boolean): void;
    getTextLabelSeethrough(label: NetHandle): boolean;
    registerCustomColShape(shape: ColShape): void;
    createSphereColShape(position: Vector3, range: number): SphereColShape;
    createCylinderColShape(position: Vector3, range: number, height: number): CylinderColShape;
    create2DColShape(x: number, y: number, width: number, height: number): Rectangle2DColShape;
    create3DColShape(start: Vector3, end: Vector3): Rectangle3DColShape;
    deleteColShape(shape: ColShape): void;
    createVehicle(model: VehicleHash, pos: Vector3, rot: Vector3, color1: number, color2: number, dimension?: number): Vehicle;
    createObject(model: number, pos: Vector3, rot: Vector3, dimension?: number): Object;
    createObject(model: number, pos: Vector3, rot: Quaternion, dimension?: number): Object;
    createBlip(pos: Vector3, range: number, dimension?: number): Blip;
    createBlip(pos: Vector3, dimension?: number): Blip;
    createBlip(entity: NetHandle): Blip;
    createPickup(pickupHash: PickupHash, pos: Vector3, rot: Vector3, amount: number, respawnTime: number, dimension?: number): Pickup;
    createPickup(model: number, pos: Vector3, rot: Vector3, vehicle: boolean, respawnTime: number, dimension?: number): Pickup;
    respawnPickup(pickup: NetHandle): void;
    createMarker(markerType: number, pos: Vector3, dir: Vector3, rot: Vector3, scale: Vector3, alpha: number, r: number, g: number, b: number, dimension?: number, bobUpAndDown?: boolean): Marker;
    createTextLabel(text: string, pos: Vector3, range: number, size: number, entitySeethrough?: boolean, dimension?: number): TextLabel;
    createPed(model: PedHash, pos: Vector3, heading: number, dimension?: number): Ped;
    createLoopedParticleEffectOnPosition(ptfxLib: string, ptfxName: string, position: Vector3, rotation: Vector3, scale: number, dimension?: number): ParticleEffect;
    createLoopedParticleEffectOnEntity(ptfxLib: string, ptfxName: string, entity: NetHandle, offset: Vector3, rotation: Vector3, scale: number, bone?: number, dimension?: number): ParticleEffect;
    deleteEntity(netHandle: NetHandle): void;
    deleteObject(client: Client, position: Vector3, modelHash: number): void;
    setCommandErrorMessage(msg: string): void;
}
type APIEmptyEvent = () => void;
type APIChatEvent = (sender: Client, message: string, cancel: GTANetworkServerCancelEventArgs) => void;
...
type APIPickupEvent = (pickupee: Client, pickupHandle: NetHandle) => void;
type APIEntityEvent = (entity: NetHandle) => void;
type APIMapChangeEvent = (mapName: string, map: GTANetworkServerXmlGroup) => void;
type APIVehicleChangeEvent = (player: Client, vehicle: NetHandle) => void;
type APIGlobalColShapeEvent = (colshape: ColShape, entity: NetHandle) => void;
type APIEntityDataChangedEvent = (entity: NetHandle, key: string, oldValue: unknown) => void;
type APIResourceEvent = (resourceName: string) => void;
type APIEntityHealthEvent = (entity: NetHandle, oldValue: number) => void;
type APIPlayerIntEvent = (player: Client, oldValue: number) => void;
type APIPlayerWeaponEvent = (player: Client, oldValue: WeaponHash) => void;
type APIPlayerAmmoEvent = (player: Client, weapon: WeaponHash, oldValue: number) => void;
type APIEntityBooleanEvent = (entity: NetHandle, oldValue: boolean) => void;
type APIEntityIntEvent = (entity: NetHandle, index: number) => void;
type APITrailerEvent = (tower: NetHandle, trailer: NetHandle) => void;
...
interface CommandInfo {
    ...
    Aliases: string[];
    Greedy: boolean;
    Parameters: unknown /* System.Reflection.ParameterInfo */[];
    Sensitive: boolean;
    ACLRequired: boolean;
    AddToHelpmanager: boolean;
    Description: string;
    Group: string;
}
interface GTANetworkServerXmlGroup {
    getSubgroup(groupName: string): GTANetworkServerXmlGroup;
    hasAnyElementOfType(typeName: string): boolean;
    getNumberOfElementsOfType(typeName: string): number;
    getElementsByType(typeName: string): GTANetworkServerxmlElement[];
    getElementByType(typeName: string): GTANetworkServerxmlElement;
}
interface Client {
    handle: NetHandle;
    readonly vehicle: Vehicle;
    readonly isInVehicle: boolean;
    readonly vehicleSeat: number;
    team: number;
    readonly ping: number;
    wantedLevel: number;
    name: string;
    readonly socialClubName: string;
    readonly isCEFenabled: boolean;
    readonly isMediaStreamEnabled: boolean;
    velocity: Vector3;
    readonly weapons: WeaponHash[];
    readonly currentWeapon: WeaponHash;
    ...
    sendNotification(message: string, flashing?: boolean): void;
    sendPictureNotificationToPlayer(body: string, pic: string, flash: number, iconType: number, sender: string, subject: string): void;
    setIntoVehicle(car: NetHandle, seat: number): void;
    warpOutOfVehicle(): void;
    setSkin(newSkin: PedHash): void;
    setDefaultClothes(): void;
    playAnimation(animDict: string, animName: string, flag: number): void;
    playScenario(scenarioName: string): void;
    stopAnimation(): void;
    setClothes(slot: number, drawable: number, texture: number): void;
    setAccessories(slot: number, drawable: number, texture: number): void;
    getClothesDrawable(slot: number): number;
    getClothesTexture(slot: number): number;
    getAccessoryDrawable(slot: number): number;
    getAccessoryTexture(slot: number): number;
    clearAccessory(slot: number): void;
    giveWeapon(weapon: WeaponHash, ammo: number, equipNow: boolean, ammoLoaded: boolean): void;
    setWeaponAmmo(weapon: WeaponHash, ammo: number): void;
    getWeaponAmmo(weapon: WeaponHash): number;
    removeWeapon(weapon: WeaponHash): void;
    removeAllWeapons(): void;
    setWeaponTint(weapon: WeaponHash, tint: WeaponTint): void;
    getWeaponTint(weapon: WeaponHash): WeaponTint;
    setWeaponComponent(weapon: WeaponHash, component: WeaponComponent): void;
    removeWeaponComponent(weapon: WeaponHash, component: WeaponComponent): void;
    hasGotWeaponComponent(weapon: WeaponHash, component: WeaponComponent): boolean;
    GetAllWeaponComponents(weapon: WeaponHash): WeaponComponent[];
    ...
    spectate(): void;
    spectate(player: Client): void;
    stopSpectating(): void;
    delete_(): void;
    movePosition(target: Vector3, duration: number): void;
    moveRotation(target: Vector3, duration: number): void;
    attachTo(entity: NetHandle, bone: string, offset: Vector3, rotation: Vector3): void;
    detach(): void;
    detach(resetCollision: boolean): void;
    createParticleEffect(ptfxLib: string, ptfxName: string, offset: Vector3, rotation: Vector3, scale: number, bone?: number): void;
    setSyncedData(key: string, value: unknown): void;
    getSyncedData(key: string): unknown;
    resetSyncedData(key: string): void;
    hasSyncedData(key: string): boolean;
    setData(key: string, value: unknown): void;
    getData(key: string): unknown;
    resetData(key: string): void;
    hasData(key: string): boolean;
    triggerEvent(eventName: string, ...args: unknown[]): void;
    downloadData(data: string): void;
}
declare enum LogCat {
    Info = 0,
    Warn = 1,
...
interface ColShape {
    handle: number;
    dimension: number;
    readonly onEntityEnterColShape: HostEvent<ColShapeEvent>;
    readonly onEntityExitColShape: HostEvent<ColShapeEvent>;
    Check(pos: Vector3): boolean;
    containsEntity(ent: NetHandle): boolean;
    setData(key: string, data: unknown): void;
    getData(key: string): unknown;
    hasData(key: string): boolean;
    resetData(key: string): void;
    getAllEntities(): NetHandle[];
}
interface SphereColShape extends ColShape {
    Center: Vector3;
    Range: number;
    Check(pos: Vector3): boolean;
    attachToEntity(entity: NetHandle): void;
}
interface CylinderColShape extends ColShape {
    Center: Vector3;
    Range: number;
    Height: number;
    Check(pos: Vector3): boolean;
...
interface Rectangle2DColShape extends ColShape {
    Start: Vector3;
    End: Vector3;
    Width: number;
    Height: number;
...
interface Rectangle3DColShape extends ColShape {
    Start: Vector3;
    End: Vector3;
    Check(pos: Vector3): boolean;
}
interface Vehicle extends Entity {
    ...
    customPrimaryColor: ConstantColor;
    customSecondaryColor: ConstantColor;
    health: number;
    livery: number;
    ...
    tyreSmokeColor: ConstantColor;
    modColor1: ConstantColor;
    modColor2: ConstantColor;
    windowTint: number;
    enginePowerMultiplier: number;
    engineTorqueMultiplier: number;
    neonColor: ConstantColor;
    dashboardColor: number;
    trimColor: number;
    readonly displayName: string;
    readonly occupants: Client[];
    ...
    repair(): void;
    popTyre(tyre: number): void;
    fixTyre(tyre: number): void;
    isTyrePopped(tyre: number): boolean;
    breakDoor(door: number): void;
    fixDoor(door: number): void;
    isDoorBroken(door: number): boolean;
    openDoor(door: number): void;
    closeDoor(door: number): void;
    isDoorOpen(door: number): boolean;
    breakWindow(window: number): void;
    fixWindow(window: number): void;
    isWindowBroken(window: number): boolean;
    setExtra(extra: number, enabled: boolean): void;
    getExtra(extra: number): boolean;
    setMod(slot: number, mod: number): void;
    getMod(slot: number): number;
    removeMod(slot: number): void;
    setNeons(slot: number, turnedon: boolean): void;
    getNeons(slot: number): boolean;
}
...
interface Ped extends Entity {
    playAnimation(dictionary: string, name: string, looped: boolean): void;
    playScenario(scenario: string): void;
    stopAnimation(): void;
}
interface ParticleEffect extends Entity {
}
interface GTANetworkServerCancelEventArgs {
    Cancel: boolean;
    Reason: string;
}
interface GTANetworkServerxmlElement {
    name: string;
    hasElementData(elementName: string): boolean;
    getElementData<T>(elementName: string): T;
}
type ColShapeEvent = (shape: ColShape, entity: NetHandle) => void;
interface Entity {
    readonly handle: NetHandle;
...
/** The API instance a Script sees (`API` inside a class deriving from Script; the Bun runtime library exposes the same shape). */
declare const API: API;
declare abstract class Script { API: API; }
